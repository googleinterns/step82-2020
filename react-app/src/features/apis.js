...
const FETCH_USER_BOOKMARKS_URL = `${BASE_URL}/fetch-user-bookmarks`;
...
const fetchUserBookmarks = (token) => axios.get(FETCH_USER_BOOKMARKS_URL, {
  headers: {
    'Authorization': token
  }
});
...
export default {
  signUp, login, logout, checkUser, addClink, addBookmark, fetchClinks, fetchUserBookmarks, fetchBookmarks
} 	
